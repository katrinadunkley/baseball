...
Below, we're copying README.txt and readme2014.txt from the original 2015 database. Note that the column names may have been modified from the ones stated in readme2014.txt. 
